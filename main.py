    ...
    try:
        async with session.get(url) as response:
            if response.status == 200:
                print("\033[92m[\033[1m+\033[92m]\033[31mSent\033[96mRequest\033[0m" )
            if response.status == 200:
                print("\033[92m[\033[1m+\033[92m]\033[31mSent\033[96m Request\033[0m" )
            if response.status == 200:
                print("\033[92m[\033[1m+\033[92m]\033[31mSen\033[96m  Request\033[0m" )
